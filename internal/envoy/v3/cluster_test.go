	...
	tests := map[string]struct {
		...
		"simple service": {
			...
			want: &envoy_v3_cluster.Cluster{
				...
				ClusterDiscoveryType: ClusterDiscoveryType(envoy_v3_cluster.Cluster_EDS),
				EdsClusterConfig: &envoy_v3_cluster.Cluster_EdsClusterConfig{
		...
		"externalName service": {
			...
			want: &envoy_v3_cluster.Cluster{
				Name:                 "default/kuard/443/da39a3ee5e",
				AltStatName:          "default_kuard_443",
				ClusterDiscoveryType: ClusterDiscoveryType(envoy_v3_cluster.Cluster_STRICT_DNS),
		...
		"externalName service - dns-lookup-family v4": {
			...
			want: &envoy_v3_cluster.Cluster{
				...
				ClusterDiscoveryType: ClusterDiscoveryType(envoy_v3_cluster.Cluster_STRICT_DNS),
				LoadAssignment:       StaticClusterLoadAssignment(service(s2)),
				DnsLookupFamily:      envoy_v3_cluster.Cluster_V4_ONLY,
			},
		},
		"externalName service - dns-lookup-family v6": {
			...
			want: &envoy_v3_cluster.Cluster{
				...
				ClusterDiscoveryType: ClusterDiscoveryType(envoy_v3_cluster.Cluster_STRICT_DNS),
				LoadAssignment:       StaticClusterLoadAssignment(service(s2)),
				DnsLookupFamily:      envoy_v3_cluster.Cluster_V6_ONLY,
			},
		},
		"externalName service - dns-lookup-family auto": {
			...
			want: &envoy_v3_cluster.Cluster{
				...
				ClusterDiscoveryType: ClusterDiscoveryType(envoy_v3_cluster.Cluster_STRICT_DNS),
				LoadAssignment:       StaticClusterLoadAssignment(service(s2)),
				DnsLookupFamily:      envoy_v3_cluster.Cluster_AUTO,
			},
		},
		...
		"cluster with random load balancer policy": {
			...
			want: &envoy_v3_cluster.Cluster{
				...
				LbPolicy: envoy_v3_cluster.Cluster_RANDOM,
			},
		},
		"cluster with cookie policy": {
			...
			want: &envoy_v3_cluster.Cluster{
				...
				LbPolicy: envoy_v3_cluster.Cluster_RING_HASH,
			},
		},
		...
		"tcp service with healthcheck": {
			...
			want: &envoy_v3_cluster.Cluster{
				...
				HealthChecks: []*envoy_v3_core.HealthCheck{{
					...
					HealthChecker: &envoy_v3_core.HealthCheck_TcpHealthCheck_{
						TcpHealthCheck: &envoy_v3_core.HealthCheck_TcpHealthCheck{},
					},
				}},
			},
		},
...
func TestLBPolicy(t *testing.T) {
	tests := map[string]envoy_v3_cluster.Cluster_LbPolicy{
		"WeightedLeastRequest": envoy_v3_cluster.Cluster_LEAST_REQUEST,
		"Random":               envoy_v3_cluster.Cluster_RANDOM,
		"RoundRobin":           envoy_v3_cluster.Cluster_ROUND_ROBIN,
		"":                     envoy_v3_cluster.Cluster_ROUND_ROBIN,
		"unknown":              envoy_v3_cluster.Cluster_ROUND_ROBIN,
		"Cookie":               envoy_v3_cluster.Cluster_RING_HASH,

		// RingHash and Maglev were removed as options in 0.13.
		// See #1150
		"RingHash": envoy_v3_cluster.Cluster_ROUND_ROBIN,
		"Maglev":   envoy_v3_cluster.Cluster_ROUND_ROBIN,
	}
...
func TestClusterCommonLBConfig(t *testing.T) {
	...
	want := &envoy_v3_cluster.Cluster_CommonLbConfig{
