...
import (
	...
	envoy_v3_matcher "github.com/envoyproxy/go-control-plane/envoy/type/matcher/v3"
...
func validationContext(ca []byte, subjectName string) *envoy_v3_tls.CommonTlsContext_ValidationContext {
	...
	if len(subjectName) > 0 {
		vc.ValidationContext.MatchSubjectAltNames = []*envoy_v3_matcher.StringMatcher{{
			MatchPattern: &envoy_v3_matcher.StringMatcher_Exact{
				Exact: subjectName,
			}},
		}
	}
