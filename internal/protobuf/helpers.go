...
// AsMessages casts the given slice of values (that implement the types.Resource
// interface) to a slice of types.Resource. If the length of the slice is 0, it
// returns nil.
...
func MustMarshalAny(pb types.Resource) *any.Any {
