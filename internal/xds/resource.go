...
func NewNotifier(e chan EnvoyMessage, log logrus.FieldLogger, resources ...Resource) Notifier {
	n := Notifier{
		Event:       e,
		FieldLogger: log,
		Context:     nil,
	...
	for i, r := range resources {
		n.resources[r.TypeURL()] = resources[i]
	}
	return n
}

func (n *Notifier) Start() func(stop <-chan struct{}) error {
	return func(stop <-chan struct{}) error {
		...
		log := n.WithField("connection", n.connections.Next())
